...
$(document).ready(function(){var i=$(".bxslider--popup").bxSlider();$(".btn-beli").click(function(){i.reloadSlider()}),$(".listmenu--logo").addClass("inactive"),$(".maininfo-wrap").hide(),$(".infomargin").show(),$(".listmenu--logo").click(function(){tinfo=$(this).attr("id"),$(this).hasClass("inactive")?($(".listmenu--logo").removeClass("inactive"),$(".listmenu--logo").addClass("active-info"),$(".sidebarmenu").animate({marginRight:"+=30%"})):($(".listmenu--logo").addClass("inactive"),$(".listmenu--logo").removeClass("active-info"),$(".sidebarmenu").animate({marginRight:"-=30%"}))}),$("#tabs1 li a:not(:first)").addClass("inactive"),$(".container-tabs1").hide(),$(".container-tabs1:first").show(),$("#tabs1 li a").click(function(){var i=$(this).attr("id");$(this).hasClass("inactive")&&($("#tabs1 li a").addClass("inactive"),$(this).removeClass("inactive"),$(".container-tabs1").hide(),$("#"+i+"-tabs1").fadeIn("slow"))}),$("#tabs2 li a:not(:first)").addClass("inactive"),$(".container-tabs2").hide(),$(".container-tabs2:first").show(),$("#tabs2 li a").click(function(){var i=$(this).attr("id");$(this).hasClass("inactive")&&($("#tabs2 li a").addClass("inactive"),$(this).removeClass("inactive"),$(".container-tabs2").hide(),$("#"+i+"-tabs2").fadeIn("slow"))})});
